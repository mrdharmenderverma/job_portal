                        ...
                        <div class="card border-0 shadow mb-4 ">
                            <div class="card-body card-form p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="benefits" id="benefits" cols="5" rows="4" placeholder="Benefits"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="responsibility" class="mb-2">Responsibility</label>
                                    <textarea class="form-control" name="responsibility" id="responsibility" cols="5" rows="4"
                                        placeholder="Responsibility"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="qualifications" class="mb-2">Qualifications</label>
                                    <textarea class="form-control" name="qualifications" id="qualifications" cols="5" rows="4"
